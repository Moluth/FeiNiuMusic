...
void main() {
  ...
  group('dynamicGradientFramesPerSecond', () {
    ...
    test('limits Android to 8 frames per second', () {
      expect(dynamicGradientFramesPerSecond(TargetPlatform.android), 8);
    });

    test('keeps iOS smoother', () {
  ...
  group('desktop texture resource limits', () {
    ...
    testWidgets(
      'desktop uses a bounded texture instead of full-screen painting',
      (tester) async {
